...
class _ChallengeCreateScreenState extends State<ChallengeCreateScreen> {
  ...
  final _oldResponseController = TextEditingController();
  final _newResponseController = TextEditingController();
  ...
  Future<void> _handleSubmit() async {
    ...
    final request = ChallengeCreateRequest(
      challengeTitle: _titleController.text,
      oldResponse: _oldResponseController.text,
      newResponse: _newResponseController.text,
      difficultyLevel: _difficultyLevel,
    );

    final challengeProvider =
        Provider.of<ChallengeProvider>(context, listen: false);
    final success = await challengeProvider.createChallenge(request);
            ...
            Consumer<ChallengeProvider>(
              builder: (context, challengeProvider, child) {
                return ElevatedButton(
                  onPressed:
                      challengeProvider.isLoading ? null : _handleSubmit,
